    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        while (j2 < i2) 
        {
            ...
            if (view.getVisibility() != 8)
            {
                ...
                {
                    j4 = layoutparams.leftMargin + layoutparams.rightMargin;
                    k4 = Math.min(k2, i1 - k1 - mOverhangSize) - j1 - j4;
                    mSlideRange = k4;
                    boolean flag1;
                    if (k4 + (j1 + layoutparams.leftMargin) + j3 / 2 > i1 - k1)
                    {
                        flag1 = true;
                    } else
                    {
                    ...
                    i3 = j1 + (l4 + layoutparams.leftMargin);
                ...
                } else
                {
                    ...
                    {
                        l3 = (int)((1.0F - mSlideOffset) * (float)mParallaxBy);
                    } else
                    {
                        l3 = 0;
                    }
                ...
                i4 = i3 - k3;
                view.layout(i4, l1, i4 + j3, l1 + view.getMeasuredHeight());
                k2 += view.getWidth();
            } else
            {
                i3 = j1;
