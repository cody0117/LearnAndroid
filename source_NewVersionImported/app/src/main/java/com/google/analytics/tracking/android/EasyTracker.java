...
_L2:
        ...
        {
            Log.i((new StringBuilder("setting appName to ")).append(mAppName).toString());
    ...
    public void activityStart(Activity activity)
    {
        ...
        if (mIsEnabled)
        {
            ...
            if (!mIsInForeground && mActivitiesActive == 0 && checkForNewSession())
            {
                ...
                boolean _tmp = mIsAutoActivityTracking;
            }
...
*/
    ...
    private class NoopTracker extends Tracker
    {
