...
//            TypeAdapter, TypeAdapterRuntimeTypeWrapper, CollectionTypeAdapterFactory, MiniGson
...
final class constructor extends TypeAdapter
{
    ...
    public (MiniGson minigson, Type type, TypeAdapter typeadapter, ObjectConstructor objectconstructor)
    {
