...
public final class TypeAdapters
{
    ...
    public static final TypeAdapter BOOLEAN_AS_STRING = new _cls3();
    ...
    public static final TypeAdapter.Factory ENUM_FACTORY = newEnumTypeHierarchyFactory(java/lang/Enum);
    ...
    public static final TypeAdapter.Factory TIMESTAMP_FACTORY = new _cls19();
    ...
    public static TypeAdapter.Factory newEnumTypeHierarchyFactory(final Class clazz)
    {
        return new _cls23();
    }

    public static TypeAdapter.Factory newFactory(final TypeToken type, final TypeAdapter typeAdapter)
    {
        return new _cls24();
    }

    public static TypeAdapter.Factory newFactory(final Class type, final TypeAdapter typeAdapter)
    {
        return new _cls25();
    }

    public static TypeAdapter.Factory newFactory(final Class unboxed, final Class boxed, final TypeAdapter typeAdapter)
    {
        return new _cls26();
    }

    public static TypeAdapter.Factory newFactoryForMultipleTypes(final Class base, final Class sub, final TypeAdapter typeAdapter)
    {
        return new _cls27();
    }

    public static TypeAdapter.Factory newTypeHierarchyFactory(final Class clazz, final TypeAdapter typeAdapter)
    {
        return new _cls28();
    }
    ...
    static 
    {
        ...
        LONG = new _cls7();
        LONG_FACTORY = newFactory(Long.TYPE, java/lang/Long, LONG);
        FLOAT = new _cls8();
        FLOAT_FACTORY = newFactory(Float.TYPE, java/lang/Float, FLOAT);
        DOUBLE = new _cls9();
        DOUBLE_FACTORY = newFactory(Double.TYPE, java/lang/Double, DOUBLE);
        NUMBER = new _cls10();
        NUMBER_FACTORY = newFactory(java/lang/Number, NUMBER);
        CHARACTER = new _cls11();
...
_L2:
            ...
            switch (_cls29..SwitchMap.com.google.gson.stream.JsonToken[jsontoken.ordinal()])
            {
            default:
...
_L3:
    ...
    private class _cls22 extends TypeAdapter
    {
        ...
        public JsonElement read(JsonReader jsonreader)
        {
            ...
            switch (_cls29..SwitchMap.com.google.gson.stream.JsonToken[jsonreader.peek().ordinal()])
            {
            default:
