    ...
    implements Parcelable
{
    ...
    protected OrderItem(Parcel parcel)
    {
        ...
        disName = parcel.readString();
        disAmt = parcel.readDouble();
    ...
    public void setDisName(String s)
    {
        disName = s;
    }
    ...
    {
        return (new StringBuilder("OrderItem [id=")).append(id).append(", itemId=").append(itemId).append(", orderId=").append(orderId).append(", billId=").append(billId).append(", categoryName=").append(categoryName).append(", itemName=").append(itemName).append(", tableName=").append(tableName).append(", itemPrice=").append(itemPrice).append(", num=").append(num).append(", remark=").append(remark).append(", startTime=").append(startTime).append(", endTime=").append(endTime).append(", cancelReason=").append(cancelReason).append(", status=").append(status).append(", orderSupplements=").append(orderModifiers).append(", printerId=").append(printerId).append(", tax1Id=").append(tax1Id).append(", tax2Id=").append(tax2Id).append(", modifierGroupId=").append(modifierGroupId).append(", disName=").append(disName).append(", disAmt=").append(disAmt).append(", qty=").append(qty).append(", isWarn=").append(isWarn).append(", warnQty=").append(warnQty).append(", selected=").append(selected).append("]").toString();
    }
    ...
    public void writeToParcel(Parcel parcel, int i)
    {
        ...
        parcel.writeString(disName);
        parcel.writeDouble(disAmt);
        if (selected)
        {
            k = j;
        } else
