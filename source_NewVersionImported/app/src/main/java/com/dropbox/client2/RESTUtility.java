...
public class RESTUtility
{
    ...
    public static String buildURL(String s, int i, String s1, String as[])
    {
        ...
        try
        {
            s2 = URLEncoder.encode((new StringBuilder("/")).append(i).append(s1).toString(), "UTF-8").replace("%2F", "/");
        }
        ...
        return (new StringBuilder("https://")).append(s).append(":443").append(s3).toString();
    }
