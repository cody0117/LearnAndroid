    ...
    implements f
{
    ...
    public LinePageIndicator(Context context, AttributeSet attributeset, int i1)
    {
        ...
        int j1 = resources.getColor(j.d);
        int k1 = resources.getColor(j.e);
        float f1 = resources.getDimension(k.d);
        float f2 = resources.getDimension(k.c);
        float f3 = resources.getDimension(k.e);
        boolean flag = resources.getBoolean(i.c);
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, m.b, i1, 0);
        f = typedarray.getBoolean(1, flag);
        g = typedarray.getDimension(5, f1);
        h = typedarray.getDimension(6, f2);
        float f4 = typedarray.getDimension(3, f3);
        b.setStrokeWidth(f4);
        a.setStrokeWidth(f4);
        invalidate();
