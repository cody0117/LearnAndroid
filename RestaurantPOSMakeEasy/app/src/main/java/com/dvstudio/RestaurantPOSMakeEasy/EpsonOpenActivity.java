...
public class EpsonOpenActivity extends Activity implements OnClickListener {
    ...
    private void openPrinter() {
        ...
        try{
            ...
            printer = null;
            EpsonShowMsg.showException(e, "openPrinter", this);
            return;
        }
        ...
        EpsonPrintSampleActivity.setPrinter(printer);
        setResult(2, intent);
        finish();
    }
}
