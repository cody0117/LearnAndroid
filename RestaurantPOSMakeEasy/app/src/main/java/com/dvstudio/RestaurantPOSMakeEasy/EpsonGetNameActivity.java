...
//import com.RestaruantPOSMakeEasy.R.string;

public class EpsonGetNameActivity extends Activity implements OnClickListener {
    ...
    private void getPrinterName() {
        ...
        if(textIp.getText().toString().isEmpty()){
            EpsonShowMsg.showError(R.string.errmsg_noaddress, this);
            return ;
        }
        ...
        if(fontName == null || printerName == null){
            EpsonShowMsg.showError(R.string.errmsg_getname, this);
        }else{
            EpsonShowMsg.showPrinterName(printerName, getLanguageSpec(fontName), this);
        }
    }
