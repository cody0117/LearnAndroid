...
public class EpsonBarcodeActivity extends Activity implements OnClickListener, OnItemSelectedListener, StatusChangeEventListener, BatteryStatusChangeEventListener {
    ...
    private void printBarcode(){
        ...
        if(text.getText().toString().isEmpty()){
            EpsonShowMsg.showError(R.string.errmsg_notext, this);
            return ;
        }
	...
	public void onStatusChangeEvent(final String deviceName, final int status) {
		runOnUiThread(new Runnable() {
			...
			public synchronized void run() {
				EpsonShowMsg.showStatusChangeEvent(deviceName, status, EpsonBarcodeActivity.this);
			}
		});
	}
	...
	public void onBatteryStatusChangeEvent(final String deviceName, final int battery) {
		runOnUiThread(new Runnable() {
			@Override
			public synchronized void run() {
				EpsonShowMsg.showBatteryStatusChangeEvent(deviceName, battery, EpsonBarcodeActivity.this);
			}
		});
	}
}
