...
public class EpsonPageModeActivity extends Activity implements OnClickListener, StatusChangeEventListener, BatteryStatusChangeEventListener {
	...
	public void onStatusChangeEvent(final String deviceName, final int status) {
		runOnUiThread(new Runnable() {
			...
			public synchronized void run() {
				EpsonShowMsg.showStatusChangeEvent(deviceName, status, EpsonPageModeActivity.this);
			}
		});
	}
	...
	public void onBatteryStatusChangeEvent(final String deviceName, final int battery) {
		runOnUiThread(new Runnable() {
			@Override
			public synchronized void run() {
				EpsonShowMsg.showBatteryStatusChangeEvent(deviceName, battery, EpsonPageModeActivity.this);
			}
		});
	}
}
