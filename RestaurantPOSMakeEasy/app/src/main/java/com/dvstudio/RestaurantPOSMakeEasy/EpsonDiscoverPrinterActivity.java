...
public class EpsonDiscoverPrinterActivity extends Activity implements OnItemClickListener, OnCheckedChangeListener, Runnable, StatusChangeEventListener, BatteryStatusChangeEventListener {
    ...
    private void findStart() {
        ...
        try{
            ...
            EpsonShowMsg.showException(e, "start", this);
            return ;
        }
	...
	public void onStatusChangeEvent(final String deviceName, final int status) {
		runOnUiThread(new Runnable() {
			@Override
			public synchronized void run() {
				EpsonShowMsg.showStatusChangeEvent(deviceName, status, EpsonDiscoverPrinterActivity.this);
			}
		});
	}
	...
	public void onBatteryStatusChangeEvent(final String deviceName, final int battery) {
		runOnUiThread(new Runnable() {
			@Override
			public synchronized void run() {
				EpsonShowMsg.showBatteryStatusChangeEvent(deviceName, battery, EpsonDiscoverPrinterActivity.this);
			}
		});
	}
}
