...
public class EpsonImageActivity extends Activity implements OnClickListener, StatusChangeEventListener, BatteryStatusChangeEventListener {
    ...
    private void printImage() {
        if(selectImage == null){
            EpsonShowMsg.showError(R.string.errmsg_noimage, this);
            return ;
        }
	...
	public void onStatusChangeEvent(final String deviceName, final int status) {
		runOnUiThread(new Runnable() {
			...
			public synchronized void run() {
				EpsonShowMsg.showStatusChangeEvent(deviceName, status, EpsonImageActivity.this);
			}
		});
	}
	...
	public void onBatteryStatusChangeEvent(final String deviceName, final int battery) {
		runOnUiThread(new Runnable() {
			@Override
			public synchronized void run() {
				EpsonShowMsg.showBatteryStatusChangeEvent(deviceName, battery, EpsonImageActivity.this);
			}
		});
	}
}
