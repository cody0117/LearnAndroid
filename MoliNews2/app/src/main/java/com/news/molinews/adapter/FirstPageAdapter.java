...
public class FirstPageAdapter extends RecyclerView.Adapter{
    ...
    public FirstPageAdapter(Context context, List<Data> item_data, BannerBean bannerBean){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_HEAD){
            ...
            holder = new ItemViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_firstfragment,parent
            ,false));
