...
public final class w
{
    ...
    public final void a()
    {
        ...
        a.delete("rest_modifierGroup", null, null);
        a.delete("rest_price_sechedule", null, null);
        a.delete("rest_order", null, null);
        a.delete("rest_orderItem", null, null);
        a.delete("rest_orderSupplement", null, null);
        a.delete("rest_order_payment", null, null);
        a.delete("rest_splitBill", null, null);
    ...
    public final void a(Order order)
    {
        ...
        a.update("rest_splitBill", contentvalues, (new StringBuilder("rowid=")).append(order.getBillId()).toString(), null);
        String s = (new StringBuilder("select discountAmt, tax1Amt, tax2Amt, serviceAmt, subtotal, amount, changeAmt, paid, paymentType from rest_order where rowid=")).append(order.getId()).toString();
        Cursor cursor = a.rawQuery(s, null);
        double d = order.getDiscountAmt();
        double d1 = order.getTax1Amt();
        double d2 = order.getTax2Amt();
        double d3 = order.getServiceAmt();
        double d4 = order.getSubTotal();
        double d5 = order.getAmount();
        ...
        contentvalues.put("serviceAmt", Double.valueOf(d3));
        contentvalues.put("subtotal", Double.valueOf(d4));
        contentvalues.put("amount", Double.valueOf(d5));
        ...
        throw exception;
        Cursor cursor1;
        String s1 = (new StringBuilder("select rowid from rest_splitBill where orderId=")).append(order.getId()).append(" and isPaid=0").toString();
        ...
        if (!order.isHasUnpaidBill())
        {
            ...
            contentvalues1.clear();
            contentvalues1.put("endtime", order.getEndTime());
            a.update("rest_orderItem", contentvalues1, (new StringBuilder("orderid=")).append(order.getId()).toString(), null);
            contentvalues1.clear();
...
_L2:
        ...
        contentvalues2.put("ordertime", order.getStartTime());
        ...
        contentvalues2.put("kitchenRemark", order.getKitchenRemark());
        ...
        for (Iterator iterator = list.iterator(); iterator.hasNext();)
        {
            ...
            contentvalues3.put("num", Integer.valueOf(orderitem.getNum()));
            ...
            contentvalues3.put("disAmt", Double.valueOf(orderitem.getDisAmt()));
            contentvalues3.put("disName", orderitem.getDisName());
            long l2 = a.insert("rest_orderItem", null, contentvalues3);
            ...
            while (iterator1.hasNext()) 
            {
                ...
                contentvalues4.put("supplementid", Long.valueOf(ordermodifier.getModifierId()));
                contentvalues4.put("qty", Integer.valueOf(ordermodifier.getQty()));
                contentvalues4.put("supplementName", ordermodifier.getModifierName());
                ...
                a.insert("rest_orderSupplement", null, contentvalues4);
            }
        }
    ...
    public final void c(Order order)
    {
        ...
        a.update("rest_orderItem", contentvalues2, (new StringBuilder("orderid=")).append(order.getId()).toString(), null);
        a.setTransactionSuccessful();
        a.endTransaction();
        return;
        Exception exception;
