...
public final class r
{
    ...
    private static final String a[] = {
        ...
        "printerName", "hostingIp", "serviceName", "marginTop", "marginBottom", "marginLeft", "marginRight", "enableBeep", "showCancelItem"
    };
    ...
    public final POSPrinterSetting a(int i)
    {
        ...
        if (flag1)
        {
            ...
            posprintersetting.setEnableTip(flag3);
            ...
            posprintersetting.setName(cursor.getString(20));
            posprintersetting.setHostingIp(cursor.getString(21));
            posprintersetting.setServiceName(cursor.getString(22));
            posprintersetting.setMarginTop(cursor.getInt(23));
            posprintersetting.setMarginBottom(cursor.getInt(24));
            posprintersetting.setMarginLeft(cursor.getInt(25));
            posprintersetting.setMarginRight(cursor.getInt(26));
    ...
    public final void a(POSPrinterSetting posprintersetting)
    {
        ...
        contentvalues.put("enableTipGuide", Boolean.valueOf(posprintersetting.isEnableTip()));
        ...
        contentvalues.put("printerName", posprintersetting.getName());
    ...
    public final POSPrinterSetting b(int i)
    {
        boolean flag = true;
        String s = "printType=1";
        if (i != 2)
        {
            s = (new StringBuilder()).append(s).append(" and enable= ").append(i).toString();
        }
    ...
    public final List c()
    {
        ...
        if (cursor.moveToFirst())
        {
            do
            {
                ...
                posprintersetting.setEnableTip(flag1);
                if (cursor.getInt(14) != 0)
                {
                    flag2 = true;
                } else
