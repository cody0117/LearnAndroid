...
public final class a
{
    ...
    public final int a(String s, double d)
    {
        ContentValues contentvalues = new ContentValues();
        contentvalues.put("amount", Double.valueOf(d));
        return b.update("rest_cash_register", contentvalues, (new StringBuilder("date||' '||time='")).append(s).append("'").toString(), null);
    }

    public final long a(CashRegister cashregister)
    {
        ContentValues contentvalues = new ContentValues();
        ...
        return b.insert("rest_cash_register", null, contentvalues);
    }
