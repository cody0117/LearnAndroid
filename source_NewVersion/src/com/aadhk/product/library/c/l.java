...
public class l
{
    ...
    public static void a(Activity activity)
    {
        ...
        intent.setData(Uri.parse((new StringBuilder("market://")).append(activity.getResources().getString(d.i)).toString()));
