...
public final class JsonExtractionException extends Exception
{
    ...
    public JsonExtractionException(String s, String s1, Object obj)
    {
        ...
        {
            s3 = (new StringBuilder(": ")).append(summarizeValue(obj)).toString();
        }
    ...
    private static String summarizeValue(Object obj)
    {
        ...
        if (obj instanceof List)
        {
            ...
            if (list.size() == 1)
            {
                return (new StringBuilder("[")).append(summarizeValue(list.get(0))).append("]").toString();
            } else
            {
                return (new StringBuilder("[")).append(summarizeValue(list.get(0))).append(", ...] (").append(list.size()).append(" elements)").toString();
            }
        } else
        {
            return d.a(obj);
