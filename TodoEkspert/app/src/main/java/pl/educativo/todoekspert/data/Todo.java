...
public class Todo implements Serializable {
    ...
    /**
     * Metoda parsująca JSON otrzymywany z Parse na model.
     * @param object
    ...
    /**
     * Metoda parsująca tablicę z JSON na listę obiektów modelowych.
     * @param jsonArray
     * @return
     * @throws JSONException
     * @throws ParseException
    ...
    /**
     * Metoda generująca ciało dla zapytania POST (tworzącego).
     * @return
     * @throws JSONException
     */
    ...
    /**
     * Metoda generująca ciało dla zapytania PUT (modyfikującego).
     * @return
     * @throws JSONException
     */
