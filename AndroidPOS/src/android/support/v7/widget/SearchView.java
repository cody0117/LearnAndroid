...
_L10:
        ...
        int j = k;
_L7:
        (new StringBuilder("Search suggestions cursor at row ")).append(j).append(" returned exception.");
        return null;
...
_L3:
        intent = createVoiceAppSearchIntent(mVoiceAppSearchIntent, searchableinfo);
        getContext().startActivity(intent);
        return;
    }
