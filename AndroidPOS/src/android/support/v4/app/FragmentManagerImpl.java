...
final class FragmentManagerImpl extends FragmentManager
{
    ...
    public final int allocBackStackIndex(BackStackRecord backstackrecord)
    {
        ...
        if (DEBUG)
        {
            (new StringBuilder("Adding back stack index ")).append(j).append(" with ").append(backstackrecord);
        }
...
_L9:
        fragment.mState;
        JVM INSTR tableswitch 1 5: default 904
    //                   1 907
    //                   2 1053
    //                   3 1023
    //                   4 993
...
_L7:
        ...
        while (k1 <= j1) 
        {
            if (DEBUG)
            {
                (new StringBuilder("Popping back stack state: ")).append(arraylist.get(k1));
            }
        ...
        if ((fragmentmanagerstate = (FragmentManagerState)parcelable).mActive != null)
        {
            ...
            while (i < fragmentmanagerstate.mActive.length) 
            {
                ...
                if (fragmentstate != null)
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("restoreAllState: active #")).append(i).append(": ").append(fragment2);
                    }
                ...
                } else
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("restoreAllState: avail #")).append(i);
                    }
            ...
            if (fragmentmanagerstate.mAdded != null)
            {
                ...
                for (int k = 0; k < fragmentmanagerstate.mAdded.length; k++)
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("restoreAllState: added #")).append(k).append(": ").append(fragment);
                    }
                    if (mAdded.contains(fragment))
                    {
            ...
            if (fragmentmanagerstate.mBackStack != null)
            {
                ...
                while (j < fragmentmanagerstate.mBackStack.length) 
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("restoreAllState: back stack #")).append(j).append(" (index ").append(backstackrecord.mIndex).append("): ").append(backstackrecord);
            ...
            if (mAdded != null)
            {
                ...
                if (i1 > 0)
                {
                    ...
                    for (j1 = 0; j1 < i1; j1++)
                    {
                        ...
                        if (DEBUG)
                        {
                            (new StringBuilder("saveAllState: adding fragment #")).append(j1).append(": ").append(mAdded.get(j1));
                        }
                    }
        ...
        if (arraylist != null)
        {
            ...
            if (k > 0)
            {
                ...
                for (l = 0; l < k; l++)
                {
                    ...
                    if (DEBUG)
                    {
                        (new StringBuilder("saveAllState: adding back stack #")).append(l).append(": ").append(mBackStack.get(l));
                    }
                }
...
_L2:
        ...
        if (DEBUG)
        {
            (new StringBuilder("Adding available back stack index ")).append(j);
        }
