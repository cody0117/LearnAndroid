    ...
    implements c
{
    ...
    private al(MgrCategoryActivity mgrcategoryactivity)
    {
        a = mgrcategoryactivity;
        super();
    }

    al(MgrCategoryActivity mgrcategoryactivity, byte byte0)
    {
        this(mgrcategoryactivity);
    }

    public final void a()
    {
        b = MgrCategoryActivity.b(a).a();
    }
