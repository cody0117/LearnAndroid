    ...
    implements c
{
    ...
    private ar(MgrItemActivity mgritemactivity)
    {
        a = mgritemactivity;
        super();
    }

    ar(MgrItemActivity mgritemactivity, byte byte0)
    {
    ...
    public final void b()
    {
        ...
        if ("1".equals(s))
        {
            MgrItemActivity.b(a, (List)b.get("serviceData"));
            return;
        }
