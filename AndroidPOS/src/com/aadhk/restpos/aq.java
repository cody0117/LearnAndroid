    ...
    implements c
{
    ...
    private aq(MgrItemActivity mgritemactivity)
    {
        a = mgritemactivity;
        super();
    }

    aq(MgrItemActivity mgritemactivity, byte byte0)
    {
    ...
    public final void b()
    {
        ...
        if ("1".equals(s))
        {
            MgrItemActivity.a(a, (Map)b.get("serviceData"));
            return;
        }
