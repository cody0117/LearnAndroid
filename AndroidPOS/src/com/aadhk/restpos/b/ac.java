...
public final class ac
{
    ...
    {
        Cursor cursor = b.query(false, "rest_user", a, (new StringBuilder("password ='")).append(s).append("'").toString(), null, null, null, null, null);
    ...
    {
        Cursor cursor = b.query(false, "rest_user", null, (new StringBuilder("role=1 and password ='")).append(s).append("'").toString(), null, null, null, null, null);
        boolean flag = cursor.moveToFirst();
        boolean flag1 = false;
        if (flag)
        {
