...
public final class y
{
    ...
    public final void a(long l)
    {
        ...
        b.update("rest_order_item", contentvalues, (new StringBuilder("orderId=")).append(l).toString(), null);
    ...
    public final void a(long l, long l1, List list, double d)
    {
...
_L1:
        b.delete("rest_split_bill", (new StringBuilder("rowid=")).append(l1).append(" and orderId=").append(l).toString(), null);
        Cursor cursor = b.query(false, "rest_split_bill", new String[] {
            "rowid"
...
_L3:
        ...
        b.update("rest_order_item", contentvalues2, (new StringBuilder("orderId=")).append(l).append(" and billId=").append(l1).toString(), null);
        OrderItem orderitem;
        ContentValues contentvalues3;
        for (Iterator iterator = list.iterator(); iterator.hasNext(); b.update("rest_order_item", contentvalues3, (new StringBuilder("rowid=")).append(orderitem.getId()).toString(), null))
        {
...
_L2:
        ...
        l1 = b.replace("rest_split_bill", null, contentvalues);
        ContentValues contentvalues1 = new ContentValues();
    ...
    {
        b.beginTransaction();
        b.delete("rest_split_bill", (new StringBuilder("rowid=")).append(l).append(" and orderId=").append(l1).toString(), null);
        ContentValues contentvalues = new ContentValues();
        contentvalues.put("billId", Integer.valueOf(0));
        b.update("rest_order_item", contentvalues, (new StringBuilder("orderId=")).append(l1).append(" and billId=").append(l).toString(), null);
        if (!flag)
        {
    ...
    public final void a(SplitBill splitbill)
    {
        ...
        b.insert("rest_split_bill", null, contentvalues);
        ContentValues contentvalues1 = new ContentValues();
    ...
    public final void a(List list, long l)
    {
        ...
        for (Iterator iterator = list.iterator(); iterator.hasNext(); b.insert("rest_split_bill", null, contentvalues1))
        {
    ...
    public final List b(long l)
    {
        ...
        Cursor cursor = b.query(false, "rest_split_bill", a, (new StringBuilder("orderId=")).append(l).toString(), null, null, null, "isPaid", null);
    ...
    public final void b(SplitBill splitbill)
    {
        ...
        contentvalues.put("amount", Double.valueOf(splitbill.getAmount()));
        contentvalues.put("isPaid", Boolean.valueOf(splitbill.isPaid()));
        b.update("rest_split_bill", contentvalues, (new StringBuilder("rowid=")).append(splitbill.getId()).toString(), null);
    }

    public final boolean c(long l)
    {
        String s = (new StringBuilder("select rowid from rest_split_bill where orderId=")).append(l).append(" and isPaid=1").toString();
        String s1 = (new StringBuilder("select rowid from rest_split_bill where orderId=")).append(l).append(" and isPaid=0").toString();
