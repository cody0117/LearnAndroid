...
public final class h
{
    ...
    public final List a()
    {
        ...
        Cursor cursor = a.query(false, "rest_discount", new String[] {
            "rowid as _id", "reason", "isPercentage", "amount"
    ...
    {
        a.delete("rest_discount", (new StringBuilder("rowid=")).append(i).toString(), null);
    }
    ...
    public final void a(Discount discount)
    {
        ...
        a.insert("rest_discount", null, contentvalues);
    }
    ...
    public final void b(Discount discount)
    {
        ...
        contentvalues.put("isPercentage", Boolean.valueOf(discount.isPercentage()));
        contentvalues.put("amount", Double.valueOf(discount.getAmount()));
        a.update("rest_discount", contentvalues, (new StringBuilder("rowid=")).append(discount.getId()).toString(), null);
    }
}
