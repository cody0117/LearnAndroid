    ...
    implements Parcelable
{
    ...
    public void setEnableTipGuide(boolean flag)
    {
        enableTipGuide = flag;
    }
    ...
    {
        return (new StringBuilder("POSPrinterSetting [fontSize=")).append(fontSize).append(", logoName=").append(logoName).append(", footer=").append(footer).append(", header=").append(header).append(", printType=").append(printType).append(", enable=").append(enable).append(", enableTipGuide=").append(enableTipGuide).append(", printSeparate=").append(printSeparate).append(", deviceId=").append(deviceId).append(", updateDate=").append(updateDate).append(", user=").append(user).append(", locale=").append(locale).append(super.toString()).append("]").toString();
    }
