    ...
    implements Parcelable
{
    ...
    {
        return (new StringBuilder("RolePermission [id=")).append(id).append(", role=").append(role).append(", function=").append(function).append(", isShow=").append(show).append(", managerPermission=").append(managerPermission).append("]").toString();
    }
