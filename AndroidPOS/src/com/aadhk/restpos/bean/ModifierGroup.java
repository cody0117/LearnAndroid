    ...
    implements Parcelable
{
    ...
    {
        return (new StringBuilder("ModifierGroup [id=")).append(id).append(", name=").append(name).append(", miniQty=").append(miniQty).append(",modifierType=").append(modifiers).append("]").toString();
    }
