...
_L3:
        try
        {
            ...
            {
                throw new h("request usb printer permission timeout");
            }
        }
        catch (InterruptedException interruptedexception)
        {
            throw new h((new StringBuilder("request usb printer permission error: ")).append(interruptedexception).toString());
        }
        Thread.sleep(100L);
          goto _L4
    }

    static BroadcastReceiver b(l l1)
    {
        return l1.i;
    }
...
_L3:
        if (!iterator.hasNext())
        {
            throw new h((new StringBuilder("Cannot open usb printer, usbInterface: deviceList:")).append(hashmap).toString());
        }
          goto _L1
        Exception exception;
        exception;
...
_L6:
        int j = 0;
_L12:
        if (j >= usbdevice.getInterfaceCount()) goto _L3; else goto _L7
_L7:
        UsbInterface usbinterface;
        usbinterface = usbdevice.getInterface(j);
        (new StringBuilder("=========connection.claimInterface========")).append(usbinterface);
        (new StringBuilder("\u63A5\u53E3\u662F:")).append(j).append(", \u7C7B\u662F:").append(usbinterface.getInterfaceClass());
        if (usbinterface.getInterfaceClass() != 7) goto _L9; else goto _L8
_L8:
        int k = usbinterface.getEndpointCount();
        int i1 = 0;
          goto _L10
_L11:
        ...
        (new StringBuilder("found usb printer \u63A5\u53E3\u662F:")).append(j).append(", \u7AEF\u70B9\u662F:").append(i1);
        e = usbendpoint;
        f = usbinterface;
...
_L5:
        (new StringBuilder("===hasPermission=false || device.getInterfaceCount() == 0")).append(usbdevice);
          goto _L3
_L10:
        if (i1 < k) goto _L11; else goto _L9
_L9:
        j++;
          goto _L12
    }
...
_L5:
        byte abyte1[];
        abyte1 = new byte[abyte0.length - k];
        System.arraycopy(abyte0, k, abyte1, 0, abyte0.length - k);
_L9:
        int j1 = d.bulkTransfer(e, abyte1, abyte1.length, a);
        if (j1 >= 0) goto _L8; else goto _L7
_L7:
        throw new h((new StringBuilder("USB printer error - bulkTransfer result:")).append(j1).toString());
        Exception exception;
        exception;
        this;
        JVM INSTR monitorexit ;
...
_L6:
        ...
        System.arraycopy(abyte0, k, abyte1, 0, 1024);
          goto _L9
_L2:
        int k1;
...
_L10:
        throw new h((new StringBuilder("USB printer error - bulkTransfer result:")).append(k1).toString());
_L8:
        k += 1024;
        j++;
