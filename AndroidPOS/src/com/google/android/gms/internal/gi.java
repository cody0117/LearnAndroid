...
public final class gi extends gu
{
    ...
    public gi(String s, ArrayList arraylist, Context context, String s1)
    {
        c = s;
        d = arraylist;
        a = s1;
...
_L2:
        long l;
        l = SystemClock.elapsedRealtime() - lf.d().a();
...
_L1:
    ...
    public final void a(int i)
    {
        ...
        hashmap.put("sku", c);
        String s;
        for (Iterator iterator = d.iterator(); iterator.hasNext(); (new md(b, a, a(s, hashmap))).e())
        {
