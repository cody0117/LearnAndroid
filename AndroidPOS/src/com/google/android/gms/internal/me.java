...
_L1:
    ...
    private static void a(ViewGroup viewgroup, ay ay1, String s, int i, int j)
    {
        ...
        } else
        {
            ...
            int k = a(context, 3);
            framelayout.addView(textview, new android.widget.FrameLayout.LayoutParams(ay1.g - k, ay1.d - k, 17));
            viewgroup.addView(framelayout, ay1.g, ay1.d);
            return;
        }
    }
    ...
    public static void b(ViewGroup viewgroup, ay ay1, String s)
    {
