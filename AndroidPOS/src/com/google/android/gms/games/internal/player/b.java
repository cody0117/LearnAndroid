...
public final class b
{
    ...
    public b(String s1)
    {
        if (TextUtils.isEmpty(s1))
        {
            ...
            t = "most_recent_external_game_id";
            u = "most_recent_game_name";
            v = "most_recent_activity_timestamp";
            w = "most_recent_game_icon_uri";
            x = "most_recent_game_hi_res_uri";
            y = "most_recent_game_featured_uri";
            return;
        } else
        {
            ...
            s = (new StringBuilder()).append(s1).append("is_profile_visible").toString();
            t = (new StringBuilder()).append(s1).append("most_recent_external_game_id").toString();
            u = (new StringBuilder()).append(s1).append("most_recent_game_name").toString();
            v = (new StringBuilder()).append(s1).append("most_recent_activity_timestamp").toString();
            w = (new StringBuilder()).append(s1).append("most_recent_game_icon_uri").toString();
            x = (new StringBuilder()).append(s1).append("most_recent_game_hi_res_uri").toString();
            y = (new StringBuilder()).append(s1).append("most_recent_game_featured_uri").toString();
            return;
        }
    }
}
