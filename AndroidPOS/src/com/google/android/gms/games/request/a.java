    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(GameRequestEntity gamerequestentity, Parcel parcel, int i)
    {
        ...
        c.a(parcel, 3, gamerequestentity.g());
        c.a(parcel, 4, gamerequestentity.d(), false);
        c.b(parcel, 5, gamerequestentity.l(), false);
        c.a(parcel, 7, gamerequestentity.h());
        c.a(parcel, 9, gamerequestentity.i());
        c.a(parcel, 10, gamerequestentity.j());
        c.a(parcel, 11, gamerequestentity.c());
        c.a(parcel, 12, gamerequestentity.k());
        c.a(parcel, j);
    }
