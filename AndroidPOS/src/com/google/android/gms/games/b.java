    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(GameEntity gameentity, Parcel parcel, int i)
    {
        ...
        c.a(parcel, 24, gameentity.y(), false);
        c.a(parcel, j);
    }
    ...
    public GameEntity a(Parcel parcel)
    {
        ...
        do
        {
            ...
            {
                return new GameEntity(j, s, s1, s2, s3, s4, s5, uri, uri1, uri2, flag, flag1, s6, k, l, i1, flag2, flag3, s7, s8, s9, flag4, flag5, flag6, s10);
            }
        } while (true);
    }
