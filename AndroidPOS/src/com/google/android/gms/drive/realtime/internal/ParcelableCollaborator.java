    ...
    implements SafeParcelable
{
    ...
    {
        return (new StringBuilder("Collaborator [isMe=")).append(b).append(", isAnonymous=").append(c).append(", sessionId=").append(d).append(", userId=").append(e).append(", displayName=").append(f).append(", color=").append(g).append(", photoUrl=").append(h).append("]").toString();
    }

    public void writeToParcel(Parcel parcel, int i)
    {
        com.google.android.gms.drive.realtime.internal.c.a(this, parcel);
    }
