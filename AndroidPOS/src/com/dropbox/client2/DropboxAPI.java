...
public class DropboxAPI
{
    ...
    private Entry commitChunkedUpload(String s, String s1, boolean flag, String s2)
    {
        ...
        String s3 = (new StringBuilder("/commit_chunked_upload/")).append(session.getAccessType()).append(s).toString();
    ...
    private UploadRequest putFileRequest(String s, InputStream inputstream, long l, boolean flag, String s1, ProgressListener progresslistener)
    {
        ...
        String s2 = (new StringBuilder("/files_put/")).append(session.getAccessType()).append(s).toString();
        if (s1 == null)
        {
            s1 = "";
        }
    ...
    public ChunkedUploadRequest chunkedUploadRequest(InputStream inputstream, long l, ProgressListener progresslistener, long l1, String s)
    {
        ...
        } else
        {
            ...
            as[1] = s;
            as[2] = "offset";
            as[3] = (new StringBuilder()).append(l1).toString();
        }
    ...
    public CreatedCopyRef createCopyRef(String s)
    {
        ...
        as[0] = "locale";
        as[1] = session.getLocale().toString();
        String s1 = (new StringBuilder("/copy_ref/")).append(session.getAccessType()).append(s).toString();
        ...
        {
            throw new DropboxParseException((new StringBuilder("Error parsing /copy_ref results: ")).append(jsonextractionexception.getMessage()).toString());
        }
    ...
    public DeltaPage delta(String s)
    {
        ...
        {
            throw new DropboxParseException((new StringBuilder("Error parsing /delta results: ")).append(jsonextractionexception.getMessage()).toString());
        }
        return deltapage;
    }
    ...
    public DropboxInputStream getFileStream(String s, String s1)
    {
        ...
        String s2 = (new StringBuilder("/files/")).append(session.getAccessType()).append(s).toString();
        String as[] = new String[4];
        as[0] = "rev";
        as[1] = s1;
        as[2] = "locale";
    ...
    {
        assertAuthenticated();
        String s1 = (new StringBuilder("/thumbnails/")).append(session.getAccessType()).append(s).toString();
        String as[] = new String[6];
        as[0] = "size";
    ...
    {
        assertAuthenticated();
        String s1 = (new StringBuilder("/media/")).append(session.getAccessType()).append(s).toString();
        RESTUtility.RequestMethod requestmethod = RESTUtility.RequestMethod.GET;
    ...
    public Entry metadata(String s, int i, String s1, boolean flag, String s2)
    {
        ...
        String s3 = (new StringBuilder("/metadata/")).append(session.getAccessType()).append(s).toString();
    ...
    public Entry restore(String s, String s1)
    {
        ...
        as[2] = "locale";
        as[3] = session.getLocale().toString();
        String s2 = (new StringBuilder("/restore/")).append(session.getAccessType()).append(s).toString();
    ...
    public List revisions(String s, int i)
    {
        ...
        as[2] = "locale";
        as[3] = session.getLocale().toString();
        String s1 = (new StringBuilder("/revisions/")).append(session.getAccessType()).append(s).toString();
    ...
    public List search(String s, String s1, int i, boolean flag)
    {
        ...
        String s2 = (new StringBuilder("/search/")).append(session.getAccessType()).append(s).toString();
        String as[] = new String[8];
        as[0] = "query";
        as[1] = s1;
        as[2] = "file_limit";
    ...
    {
        assertAuthenticated();
        String s1 = (new StringBuilder("/shares/")).append(session.getAccessType()).append(s).toString();
        RESTUtility.RequestMethod requestmethod = RESTUtility.RequestMethod.GET;
        String s2 = session.getAPIServer();
        String as[] = new String[2];
        as[0] = "locale";
    ...
    private class DropboxInputStream extends FilterInputStream
    {
        private class DropboxFileInfo
        {
            ...
            private static Entry parseXDropboxMetadata(HttpResponse httpresponse)
            {
                ...
                Object obj = d.a(new StringReader(header.getValue()));
                if (obj == null)
                {
                    return null;
                } else
