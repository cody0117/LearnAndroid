    ...
    public partial class AddReview : PhoneApplicationPage
    {
        ...
        public void SaveReviewButton_Click(object sender, EventArgs e)
        {
            if (validInput())
            {
                ...
                inputContent += "date: " + String.Format("{0:yyyy/MM/dd}", dpCreateDate.Value) + Environment.NewLine;
                inputContent += "meal: " + tbMeal.Text.ToString().Trim() + Environment.NewLine;
                inputContent += "cost: " + tbCost.Text.ToString().Trim() + Environment.NewLine;
                inputContent += "rating: " + RatingMark + Environment.NewLine;
                inputContent += "comments: " + tbComments.Text.ToString().Trim() + Environment.NewLine;
                inputContent += "image: " + Path.GetFileName(tbImgPath.Text);
                if (MessageBox.Show("the following review will be saved" + inputContent, "save record", MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    ...
                    ttShow.Title = "save review: ";
                    ttShow.Message = "successfully";
