...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
     ...
     */
    public FirebaseListAdapter(final Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        ...
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
              ...
              // List<model> listOfModel = new ArrayList<mModels>();
    ...
    private void printData(DataSnapshot data) {
        ...
        for (DataSnapshot child : data.getChildren()) {
            ...
            System.out.println("Output from child " + data.child("message").getValue() + "  price is" + data.child("price").getValue());
...
//        System.out.println(data.child("message") + ":" + data.child("price"));
//        while (it.hasNext()) {
...
//
//        }
//        System.out.println(" Total of the bill is $ "+total);
//
//    }
